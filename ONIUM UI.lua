...
local settingsTable = {
	General = {
		...
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Tutup Ui'},
		-- buildwarnings
		-- rayfieldprompts
...
do
	...
	-- Ganti baris 299 dengan:
    Rayfield.Loading.Banner.Image = "https://i.imgur.com/GIISYHW.png"
...
local function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 300, 0, 200) or UDim2.new(0, 450, 0, 380)}):Play()
TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 300, 0, 45)}):Play()
...
local function Unhide()
	...
	Main.Visible = true
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 400, 0, 220) or UDim2.new(0, 450, 0, 380)}):Play()
...
local function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 295, 0, 45)}):Play()
TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 295, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if not Settings.DisableRayfieldPrompts then
		task.spawn(function()
			while not rayfieldDestroyed do
				...
				RayfieldLibrary:Notify({
					Title = "ONIUM",
					Content = "SLAMAT MENIKMATI ENJOY GUYS",
					Duration = 7,
					Image = 4370033185,
				})
			end
	...
	task.wait(0.1)
	TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Size = useMobileSizing and UDim2.new(0, 300, 0, 200) or UDim2.new(0, 450, 0, 380)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {ImageTransparency = 0.6}):Play()
